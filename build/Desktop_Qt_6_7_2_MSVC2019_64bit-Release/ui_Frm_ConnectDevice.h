...
public:
    ...
    void setupUi(QDialog *Frm_ConnectDevice)
    {
        if (Frm_ConnectDevice->objectName().isEmpty())
            Frm_ConnectDevice->setObjectName("Frm_ConnectDevice");
        ...
        get_Ip_LineEdit->setObjectName("get_Ip_LineEdit");
        ...
        clickTo_Open_Frm_GetIP_PushButton->setObjectName("clickTo_Open_Frm_GetIP_PushButton");
