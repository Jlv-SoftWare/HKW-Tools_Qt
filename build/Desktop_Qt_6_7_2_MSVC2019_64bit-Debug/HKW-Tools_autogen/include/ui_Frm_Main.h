...
public:
    ...
    QPushButton *clickTo_ReloadDeviceInfo_PushButton;
    QGroupBox *funs_GroupBox;
    QListWidget *funs_ListWidget;

    void setupUi(QDialog *Frm_Main)
    {
        if (Frm_Main->objectName().isEmpty())
            Frm_Main->setObjectName("Frm_Main");
        Frm_Main->resize(340, 460);
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/Icon/HKW-Tools_Icon.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        devicesInfos_GroupBox->setGeometry(QRect(10, 10, 201, 441));
        ...
        clickTo_Open_Frm_ConnectDevice_PushButton->setGeometry(QRect(10, 390, 181, 41));
        QFont font;
        ...
        deviceInfo_GroupBox->setGeometry(QRect(10, 70, 181, 311));
        ...
        show_UsedStorage_ProgressBar->setGeometry(QRect(10, 220, 161, 16));
        ...
        show_DeviceModel_LineEdit->setGeometry(QRect(82, 20, 91, 20));
        ...
        show_CpuModel_LineEdit->setGeometry(QRect(82, 50, 91, 20));
        ...
        show_Manufacturer_LineEdit->setGeometry(QRect(82, 80, 91, 20));
        ...
        show_AndroidVersion_LineEdit->setGeometry(QRect(82, 110, 91, 20));
        ...
        show_CurrentDpi_LineEdit->setGeometry(QRect(82, 140, 91, 20));
        ...
        show_CurrentResolution_LineEdit->setGeometry(QRect(82, 170, 91, 20));
        ...
        label_9->setGeometry(QRect(90, 240, 31, 16));
        ...
        show_UsedStorage_LineEdit->setGeometry(QRect(120, 240, 40, 20));
        show_UsedStorage_LineEdit->setFrame(false);
        show_UsedStorage_LineEdit->setReadOnly(true);
        clickTo_ReloadDeviceInfo_PushButton = new QPushButton(deviceInfo_GroupBox);
        clickTo_ReloadDeviceInfo_PushButton->setObjectName("clickTo_ReloadDeviceInfo_PushButton");
        clickTo_ReloadDeviceInfo_PushButton->setGeometry(QRect(20, 270, 141, 24));
        funs_GroupBox = new QGroupBox(Frm_Main);
        funs_GroupBox->setObjectName("funs_GroupBox");
        funs_GroupBox->setGeometry(QRect(220, 10, 111, 441));
        funs_ListWidget = new QListWidget(funs_GroupBox);
        funs_ListWidget->setObjectName("funs_ListWidget");
        funs_ListWidget->setGeometry(QRect(10, 20, 91, 411));
        QFont font1;
        font1.setPointSize(10);
        funs_ListWidget->setFont(font1);
    ...
    void retranslateUi(QDialog *Frm_Main)
    {
        ...
        clickTo_Open_Frm_ConnectDevice_PushButton->setText(QCoreApplication::translate("Frm_Main", "\350\277\236\346\216\245&&\351\205\215\345\257\271\350\256\276\345\244\207", nullptr));
        ...
        clickTo_ReloadDeviceInfo_PushButton->setText(QCoreApplication::translate("Frm_Main", "\346\211\213\345\212\250\345\210\267\346\226\260", nullptr));
