...
Q_CONSTINIT const QMetaObject Frm_Main::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSFrm_MainENDCLASS_t,
        ...
        // method 'selectDeviceStatusChance'
...
void Frm_Main::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->selectDeviceStatusChance(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Frm_Main::*)();
            if (_t _q_method = &Frm_Main::selectDeviceStatusChance; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Frm_Main::selectDeviceStatusChance()
{
